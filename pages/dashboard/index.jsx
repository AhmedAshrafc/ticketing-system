    ...
    <>
      ...
      <div className="grid grid-cols-fluid gap-5 cursor-pointer">
        ...
        <div className="bg-white text-xl p-6 text-center opacity-80 relative transition-all hover:opacity-100 group">
          <div className="before:content-[''] absolute top-0 right-0 w-[2px] h-[0px] bg-blue-500 transition-all duration-1000 group-hover:h-full"></div>
          <div className="after:content-[''] absolute bottom-0 left-0 w-[2px] h-[0px] bg-blue-500 transition-all duration-1000 group-hover:h-full"></div>
